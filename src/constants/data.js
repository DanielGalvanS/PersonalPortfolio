...
export const projects = [
  {
    ...
    image: ["/HORNO3/horno3-splash.JPG", "/HORNO3/horno3-home.JPG"],
    ...
    gallery: [
      ...
      { src: "/HORNO3/H3.png", caption: "Interactive indoor museum map" },
      { src: "/HORNO3/H4.png", caption: "Exhibition details" },
      { src: "/HORNO3/H5.png", caption: "Exhibit explanation guide through Core ML + GPT-4" },
      {
        type: 'youtube',
        src: "https://www.youtube.com/embed/n7B8ll3jKQk",
        caption: "Horno 3 Personalized Guide Demo"
      },
      { src: "/HORNO3/H6.png", caption: "Admin dashboard with user statistics" },
      { src: "/HORNO3/H7.png", caption: "Reviews and recent activity regarding users and changes made by staff" },
      { src: "/HORNO3/H8.png", caption: "Museum section information and management" },
      { src: "/HORNO3/H9.png", caption: "Show management" },
      { src: "/HORNO3/H10.png", caption: "App announcements" },
    ],
  },
  {
  ...
  },
  {
    ...
    description: "Web platform for managing AIOps operational workflows, centralizing system logs, and monitoring infrastructure metrics. Features an AI assistant integrated with MCP to query PostgreSQL logs and execute actions across external services. Enables Jira workflow analysis and automation including ticket creation, incident management, and workflow orchestration, alongside Slack integration for operational alerts and communication, with role-based access control. Designed and configured CI/CD pipelines and deployment environments via Azure DevOps.",
    image: "/AION/AP.png",
